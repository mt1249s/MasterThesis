...
dl_test = torch.utils.data.DataLoader(ds_test, collate_fn=collate_seqs, batch_size=train.batch_size, shuffle=True)
...
with torch.no_grad():
    ...
    print(f'Accuracy of the network on the 7000 test RNA sequences: {acc_test:.4f} %')
